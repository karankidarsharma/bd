...
function validate()
{
    ...
    if (document.getElementById("Text1").value=="Email:")
    {
          alert("Enter An Email");
          return false;
          }
      var emailPat = /^(\".*\"|[A-Za-z]\w*)@(\[\d{1,3}(\.\d{1,3}){3}]|[A-Za-z]\w*(\.[A-Za-z]\w*)+)$/;
     var emailid=document.getElementById("Text1").value;
     ...
     if (matchArray == null)
    {
       ...
       if (document.getElementById("Text2").value=="Password:")
       {
	...
	<tr>
		...
		<table style="width: 100%">
			<tr>
				...
				<form action="edit_user1.php" method="post"  onsubmit="javascript:return validate ();">
				
					<br />
					<br />
					<strong><span class="style15">User Login</span></strong><br />
					<br />
					<input name="Text1" style="width: 159px; height: 23px" type="text" id="Text1" onfocus="if(this.value=='Email:')this.value='';" onblur="if(this.value=='')this.value='Email:';" value="Email:"/>&nbsp;
					<input name="Text2" style="width: 159px; height: 23px" type="text" id="Text2" onfocus="if(this.value=='Password:')this.value='';" onblur="if(this.value=='')this.value='Password:';"value="Password:" />&nbsp;&nbsp;&nbsp;
					<input name="Submit1" style="width: 72px" type="submit" value="Login" /><br />
					<br />
					<br />
					<br />
					<br />
